...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, MatTableModule, MatPaginatorModule, MatButtonToggleModule, MatFormFieldModule, MatInputModule, MatGridListModule, HttpClientModule, CommonModule, MatProgressSpinnerModule ],
